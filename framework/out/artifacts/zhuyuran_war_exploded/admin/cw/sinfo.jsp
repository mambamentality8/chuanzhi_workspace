...
<div class="title_right"><strong>班级信息管理</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>所属科室</strong></td>
         <td nowrap="nowrap"><strong>备注说明</strong></td>
         <td width="80" nowrap="nowrap"><strong>操作</strong></td>
       </tr>
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from cw where mc like '%"+word+"%' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from cw where mc like '%"+word+"%' order by id desc",4);
...
%>       
       <tr align="center">
         ...
         <a href="<%=basePath%>ComServlet?method=delcw&id=<%=pagelist2.get(0).toString()%>">删除</a>
         </td>
       </tr>
<% }} %>
       <tr align="center">
