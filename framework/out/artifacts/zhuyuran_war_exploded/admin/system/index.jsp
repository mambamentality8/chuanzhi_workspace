...
<div class="title_right" style="background:#e5f9fc;"><strong>系统用户管理</strong></div>  
<div style="width:100%;margin:auto;">
<form action="" method="post" name="form3">	
<table class="table table-bordered table-striped table-hover" style="height:100px;">
     <tbody>
       <tr align="center">
         <td nowrap="nowrap"><strong>序号</strong></td>
         <td nowrap="nowrap"><strong>帐号</strong></td>
