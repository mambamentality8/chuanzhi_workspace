...
<div class="title_right" style="background:#e5f9fc;height:35px;"><strong>密码修改</strong></div>  
...
<table class="table table-bordered" style="height:150px;">
	 <tr>
     <td width="25%" align="right" nowrap="nowrap" >旧&nbsp;&nbsp;密&nbsp;&nbsp;码：</td>
     <td><input type="password" name="oldpwd" class="span3" bgcolor="f5fffc" required/></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" >新&nbsp;&nbsp;密&nbsp;&nbsp;码：</td>
     <td><input type="password" name="newpwd" id="newpwd" bgcolor="f5fffc" onchange="checkPasswords()" class="span3" required/></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" >确认密码：</td>
