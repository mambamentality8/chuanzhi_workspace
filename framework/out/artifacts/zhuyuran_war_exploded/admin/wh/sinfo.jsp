...
function top2(){
   	form3.action="<%=basePath%>admin/wh/sinfo.jsp?page=1";
    form3.submit();
}
function last2(){
	...
	form3.action="<%=basePath%>admin/wh/sinfo.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre2(){
  ...
  if(page<=1){
    ...
    form3.action="<%=basePath%>admin/wh/sinfo.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump2(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%>admin/wh/sinfo.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%>admin/wh/sinfo.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%>admin/wh/sinfo.jsp?page="+page;
      form3.submit();
...
<div class="title_right"><strong>电子病历管理</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>病人编号</strong></td> 
         <td nowrap="nowrap"><strong>病患详情</strong></td> 
         <td nowrap="nowrap"><strong>医嘱信息</strong></td> 
         <td nowrap="nowrap"><strong>备注信息</strong></td> 
         <td width="80" nowrap="nowrap"><strong>操作</strong></td>
       </tr>
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from wh where cw like '%"+word+"%' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from wh where cw like '%"+word+"%' order by id desc",5);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap">
         <a href="<%=basePath%>admin/wh/add.jsp?method=upwh&id=<%=pagelist2.get(0).toString()%>">修改</a> 
         <a href="<%=basePath%>ComServlet?method=delwh&id=<%=pagelist2.get(0).toString()%>">删除</a>
         </td>
       </tr>
<% }} %>
       <tr align="center">
